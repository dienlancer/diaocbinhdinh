            ...
            <div class="col-lg-7 no-padding">
                <div class="bg-contact">
                    <div class="thong-tin-lien-lac">
                        <div class="col-lg-6">
                            <div class="col-lg-2 no-padding"><img src="<?php echo site_url( '/wp-content/uploads/position.png', null ); ?>" /></div>
                            <div class="col-lg-10 position-color">
                                <div class="vi-tri">VỊ TRÍ</div>
                                <div><?php echo $address; ?></div>
                            </div>
                        </div>
                        <div class="col-lg-6 position-color">
                            <div class="goi-ngay">GỌI NGAY</div>
                            <div class="phone-vitri"><?php echo $contacted_phone; ?></div>
                        </div>
                        <div class="clr"></div>
                    </div>
                </div>                
