...
function zendvn_theme_widgets_init(){	
	...
	register_sidebar(array(
		'name'          => __( 'Introduce1Widget', $themeName ),
		'id'            => 'introduce-1-widget',		
		'class'         => '',
		'before_widget' => '<div id="%1$s" class="%2$s">',
		'before_title'  => '<h3 class="tms-chi-co-h-title">',
		'after_title'   => '</h3>',
		'after_widget'  => '</div>'				
	));
	register_sidebar(array(
		'name'          => __( 'Introduce2Widget', $themeName ),
		'id'            => 'introduce-2-widget',		
		'class'         => '',
		'before_widget' => '<div id="%1$s" class="%2$s">',
		'before_title'  => '<h3 class="tms-chi-co-h-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar(array(
		'name'          => __( 'Introduce3Widget', $themeName ),
		'id'            => 'introduce-3-widget',		
		'class'         => '',
		'before_widget' => '<div id="%1$s" class="%2$s">',
		'before_title'  => '<h3 class="tms-chi-co-h-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar(array(
		'name'          => __( 'Introduce4Widget', $themeName ),
		'id'            => 'introduce-4-widget',		
		'class'         => '',
		'before_widget' => '<div id="%1$s" class="%2$s">',
		'before_title'  => '<h3 class="tms-chi-co-h-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar(array(
		'name'          => __( 'LuxuryVillaWidget', $themeName ),
		'id'            => 'luxury-villa-widget',		
		'class'         => '',
		'before_widget' => '<div id="%1$s" class="%2$s">',
		'before_title'  => '<h6>',
		'after_title'   => '</h6>',
	...
	register_sidebar(array(
		'name'          => __( 'CanHoMotPhongNguWidget', $themeName ),
		'id'            => 'can-ho-mot-phong-ngu-widget',		
		'class'         => '',
		'before_widget' => '<div id="%1$s" class="%2$s">',
		'before_title'  => '<h6>',
		'after_title'   => '</h6>',
	...
	register_sidebar(array(
		'name'          => __( 'CanHoHaiPhongNguWidget', $themeName ),
		'id'            => 'can-ho-hai-phong-ngu-widget',		
		'class'         => '',
		'before_widget' => '<div id="%1$s" class="%2$s">',
		'before_title'  => '<h6>',
		'after_title'   => '</h6>',
